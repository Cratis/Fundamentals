...
public class when_initializing_with_type_with_target_type_mismatch : given.derived_types
{
    interface IFirst;
    interface ISecond;
    ...
    [Fact] void should_throw_target_type_mismatch() => result.ShouldBeOfExactType<TargetTypeMismatchForDerivedType>();
}
