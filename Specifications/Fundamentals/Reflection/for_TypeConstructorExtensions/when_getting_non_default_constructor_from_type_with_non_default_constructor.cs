...
public class when_getting_non_default_constructor_from_type_with_non_default_constructor : Specification
{
    ConstructorInfo constructor_info;

    void Because() => constructor_info = typeof(TypeWithoutDefaultConstructor).GetNonDefaultConstructor();
