...
public class ActivitySource<T>(DiagnosticsActivitySource? activitySource = null, IServiceProvider? serviceProvider = null, [ServiceKey] string? serviceKey = null) : IActivitySource<T>
{
    /// <inheritdoc/>
    ...
    static DiagnosticsActivitySource? ResolveKeyedActivitySource(IServiceProvider? provider, string? key) =>
