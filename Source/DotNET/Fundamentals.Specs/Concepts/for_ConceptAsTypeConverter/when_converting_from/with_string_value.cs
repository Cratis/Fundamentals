...
public class with_string_value : given.a_concept_as_type_converter
{
    object result;
    ...
    [Fact] void should_hold_the_converted_value() => ((TypeConverterConcept)result).Value.ShouldEqual(42);
}
