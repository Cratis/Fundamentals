...
public class when_adding_named_meter : Specification
{
    const string meterName = "my-meter";
    IServiceProvider _serviceProvider;
    Metrics.IMeter<when_adding_named_meter> _typedMeter;
    Meter _meter;
    ...
    void Because()
    {
        _typedMeter = _serviceProvider.GetRequiredKeyedService<Metrics.IMeter<when_adding_named_meter>>(meterName);
